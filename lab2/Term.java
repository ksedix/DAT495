...
public class Term {
    ...
    // TODO
    public static final Comparator<Term> byLexicographicOrder = new Comparator<>() {
        @Override
        public int compare(Term o1, Term o2) {
            String word1 = o1.getWord();
            String word2 = o2.getWord();
            return word1.compareToIgnoreCase(word2); //will automatically compare the 2 words lexicographically
        }
    };

    // Compares two terms in descending order by weight.
    // TODO
    public static final Comparator<Term> byReverseWeightOrder = new Comparator<>() {
        @Override
        public int compare(Term o1, Term o2) {
            return Long.compare(o1.getWeight(),o2.getWeight())*-1;
        }
    };
    ...
    public static Comparator<Term> byPrefixOrder(int k) {
        ...
        return new Comparator<>() {
            ...
            public int compare(Term o1, Term o2) {
                ...
                return prefix1.compareToIgnoreCase(prefix2); //will automatically compare the 2 words lexicographically
            }
        };
