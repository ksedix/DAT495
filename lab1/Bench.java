...
public class Bench {
    ...
    public static void main(final String[] args) {
        ...
        //executionTimeReport("Quick.java: quicksort (No Improvements)", new Quick(false, false, 0)::sort);

        //executionTimeReport("Quick.java: quicksort with One improvement (Shuffle)", new Quick(true, false, 0)::sort);
        //executionTimeReport("Quick.java: quicksort with One improvement (MedianOf3)", new Quick(false, true, 0)::sort);
        //executionTimeReport("Quick.java: quicksort with One improvement (InsertionSort)", new Quick(false, false, 60)::sort);
        //executionTimeReport("Quick.java: quicksort with all improvements", new Quick(true, true, 60)::sort);
        executionTimeReport("Quick.java: quicksort with Best Combination of Improvements", new Quick(false, true, 60)::sort);
